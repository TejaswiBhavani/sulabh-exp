/*
  # Add departments table and related functionality
  
  This migration adds:
  1. Departments table for organizing authorities
  2. RLS policies for department access
  3. Initial department data
  4. Functions for department statistics and assignment
  5. Additional profile columns for notifications
*/

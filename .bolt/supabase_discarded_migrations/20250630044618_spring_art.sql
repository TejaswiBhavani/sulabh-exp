/*
  # Department Management and Profile Enhancements
  ...
  2. New Views
    - `department_stats` - Shows department statistics

  3. New Functions
    - `get_department_statistics` - Returns complaint statistics for a department
    - `auto_assign_complaint_to_department` - Automatically assigns complaints to departments
    - `assign_department_to_user` - Assigns a user to a department

  4. Profile Enhancements
    - Added `is_phone_verified` column
    - Added `email_notification_enabled` column
*/
